...
Source: [`packages/schedule/scheduled-tasks/src/index.ts:37`](../packages/schedule/scheduled-tasks/src/index.ts)
...
- `@deepseek-ai/dsh-api-scheduled-task-controller` — requires `scheduledTasks` ([`packages/api/scheduled-task-controller/src/index.ts`](../packages/api/scheduled-task-controller/src/index.ts))
