...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  scheduledTaskController: 'scheduled-tasks.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ScheduledTask: 'Host scheduled-task record is owned by packages/schedule/scheduled-tasks/README.md',
  ScheduledTaskId: 'Host scheduled-task identity is owned by packages/schedule/scheduled-tasks/README.md',
  ScheduledTaskInput: 'Host scheduled-task creation fields are owned by packages/schedule/scheduled-tasks/README.md',
  ScheduledTaskUpdate: 'Host scheduled-task update fields are owned by packages/schedule/scheduled-tasks/README.md',
  ScheduledTaskRun: 'Host scheduled-task run record is owned by packages/schedule/scheduled-tasks/README.md',
  ScheduledTaskRunId: 'Host scheduled-task run identity is owned by packages/schedule/scheduled-tasks/README.md',
  ChangedListener: 'service-local change listener is owned by packages/schedule/scheduled-tasks/src/index.ts',
}
